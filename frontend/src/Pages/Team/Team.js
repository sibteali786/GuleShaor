...
const Team = () => {
  ...
  return (
    <div className="team-container">
      <h1>The Team</h1>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Non, diam, leo
        donec laoreet in est amet odio tincidunt. Maecenas ac, porta vel lacinia
        odio ut quam ornare!
      </p>
          ...
          <Grid key={index} item xs={12} sm={12} md={6}>
            <div className="card">
              ...
              <div className="card-text">
                <img className="portada" src={team.profilePic} alt="profile" />
                <div className="title-total">
                  ...
                  {team.socialMedia.map(s => (
                    ...
                    >
                      <button>
                      {s.includes('github') ? (<i class="fa-brands fa-github"></i>) : s.includes('linkedin') ? 
                      (<i class="fa-brands fa-linkedin"></i>) : s.includes('medium') ? (<i class="fa-brands fa-medium"></i>) : 
                    s.includes('instagram') ? (<i class="fa-brands fa-instagram"></i>) : (<i class="fa-regular fa-eye"></i>) }
                      </button>
                    </a>
                  ))}
                  </div>
