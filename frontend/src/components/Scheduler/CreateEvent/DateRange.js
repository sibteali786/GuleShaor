  ...
  return (
    ...
    >
      <Grid
        container
        spacing={2}
        className="p-[2rem] bg-white flex flex-col justify-center border-2 border-gray-600 rounded-sm mb-[2rem]"
      >
        <Grid item xs={12}>
        ...
        {errors.availability?.message === "Please select date range option" ? (
          <Grid item xs={12}>
            <Typography color="error" variant="subtitle2">
              Please select a date range option
            </Typography>
          </Grid>
        ) : null}
        {errors.dateRangeOption?.message === "Please select a start date" ? (
          <Grid item xs={12}>
            <Typography color="error" variant="subtitle2">
        ...
        {errors.endDate?.type === "max" ? (
          <Grid item xs={12}>
            <Typography color="error" variant="subtitle2">
              End date should be before or equal to today's date
            </Typography>
          </Grid>
        ) : null}
        {errors.startDate?.type === "max" ? (
          <Grid item xs={12}>
            <Typography color="error" variant="subtitle2">
              Start date should not be after today's date
            </Typography>
          </Grid>
        ) : null}
        {errors.startDate?.type === "validate" ? (
          <Grid item xs={12}>
            <Typography color="error" variant="subtitle2">
              Start date should be at least one day before end date
            </Typography>
          </Grid>
        ) : null}
